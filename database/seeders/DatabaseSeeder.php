...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $allStudents = collect([
            ...
            User::create(['first_name' => 'LUIS ANGEL', 'last_name' => 'CONZALES BERROCAL', 'full_name' => 'LUIS ANGEL CONZALES BERROCAL', 'dni' => '12121212', 'email' => 'luis.conzales@example.com', 'password' => Hash::make('password'), 'role' => ['student'], 'status' => 'active', 'email_verified_at' => now()]),
        ...
        $this->command->info('   - Credenciales (Certificados): ' . Credential::count());
    }
}