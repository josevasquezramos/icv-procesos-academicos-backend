...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $allStudents = collect([
            ...
            User::create(['first_name' => 'EDWIN FIDENCIO', 'last_name' => 'OSORIO JUAQUIN', 'full_name' => 'EDWIN FIDENCIO OSORIO JUAQUIN', 'dni' => '99999997', 'document' => 'DOC-ADMIN', 'email' => 'edwin@example.com', 'password' => Hash::make('12345678'), 'role' => ['student', 'admin'], 'status' => 'active', 'email_verified_at' => now()]),
            User::create(['first_name' => 'RODRIGO EMILIO', 'last_name' => 'TREJO OBREGON', 'full_name' => 'RODRIGO EMILIO TREJO OBREGON', 'dni' => '77777779', 'document' => 'DOC-AUDITAR', 'email' => 'auditor2@example.com', 'password' => Hash::make('12345678'), 'role' => ['student', 'auditor'], 'status' => 'active', 'email_verified_at' => now()]),
        ]);
